 ...
 */
final class Version20240809144809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employee DROP password, DROP role, DROP active');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employee ADD password VARCHAR(255) NOT NULL, ADD role VARCHAR(255) NOT NULL, ADD active TINYINT(1) DEFAULT NULL');
    }
}
